...
st.error("**When licensed pharmacies are not available, patients face difficult choices: forgo their medications, source them from unlicensed research facilities and unregulated online markets, or travel to other states.**")
...
st.write("To identify what specialties are being served by sterile compounding pharmacies I visited each of the 105 pharmacy websites. They may provide services to other types of providers, but below are what they are publically advertising.")
st.write("While most pharmacies did not have a web presence, or provided no insight to what types of specialties they might serve, there were several that appeared frequently - such as Hormone Replacement Therapy, Oncology, Dermatology, Hospice, Nutrition, and Opthalmic medications.")
...
st.write("To identify what types of conditions the licensed and available sterile compounding pharmacies are able to treat we visited each of their 105 websites.  This list is not exhaustive, and includes only what the pharmacies have made publicly available on their respective websites.")
st.info("Note that out of 845 licenses, only (5) or fewer pharmacies were identified as specializing in treatments for these conditions, or any other condition.")
